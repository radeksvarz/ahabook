...
from ahauser.models import AhaUser
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = AhaUser
        fields = ('email', 'password', 'gender', 'is_active', 'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('email', 'email_post', 'password', 'date_joined', 'updated')}),
    ...
    readonly_fields = ('updated', 'date_joined', 'email_post')
    search_fields = ('email',)
    ordering = ('email',)
    filter_horizontal = ()

# Now register the new UserAdmin...
admin.site.register(AhaUser, UserAdmin)
